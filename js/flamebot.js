...
var Announcer, BigCar, ButtonAnnouncer, ButtonWatcher, Car, CompassAnnouncer, CompassCalibrator, CompassDisplay, CorrectionAnnouncer, CrashAnnouncer, Driving, LittleCar, LocationAnnouncer, OrientationAnnouncer, RobotBatteryLimit, RobotCountState, RobotFindingState, RobotFlaggingState, RobotLoopState, RobotPhotographingState, RobotSequentialState, RobotState, RobotTimeLimit, StateTracker, Steering, TimeAnnouncer,
...
RobotState = (function() {
  ...
  RobotState.prototype.responseTo = function(property, args) {
    if (args == null) {
      args = [];
    }
    if (this[property]) {
  ...
  RobotState.prototype.fullName = function() {
    if (this.parent) {
...
Steering = (function(_super) {
  __extends(Steering, _super);

  function Steering(driver) {
    Steering.__super__.constructor.call(this, "steering", [], driver, 1);
    this.left_turning = this.addChild(new Driving("left", [], driver, 5));
    this.right_turning = this.addChild(new Driving("right", [], driver, 6));
  }

  Steering.prototype.listener = function(currentState, event) {
    var d, newState;
    d = event.correction;
    if (!d) {
      return null;
...
RobotFindingState = (function(_super) {
  ...
  function RobotFindingState(basename, goals, strategy, location, perimeter, compass_variance) {
