...
var Announcer, BigCar, ButtonAnnouncer, ButtonWatcher, CompassAnnouncer, CompassCalibrator, CompassDisplay, CrashAnnouncer, Driving, ImaginaryCar, LittleCar, LocationAnnouncer, OrientationAnnouncer, RobotBatteryLimit, RobotFindingState, RobotFlaggingState, RobotLoopState, RobotPhotographingState, RobotSequentialState, RobotState, RobotTimeLimit, StateTracker, TimeAnnouncer,
...
RobotState = (function() {
  ...
  RobotState.prototype.listener = function(currentState, event) {
    return null;
  };
  ...
  RobotState.prototype.processEvent = function(currentState, event) {
    ...
    return this.listener(currentState, event);
  };
