...
var RobotFindingState, RobotFlaggingState, RobotLoopState, RobotPhotographingState, RobotSequentialState, RobotState, RobotTestMachine, RobotTimeLimit, announceBotEvent, drive, finderBotState,
...
RobotTestMachine = (function(_super) {
  ...
  function RobotTestMachine() {
    ...
    this.go = this.addChild(new RobotSequentialState("stepping", ["go"]));
    this.store = this.addChild(new RobotFlaggingState("storing", ["store"], this.go));
    this.reset = this.addChild(RobotState("resetting", ["reset"], function(currentState, event) {
...
$(function() {
  var action, crash_id, interval_id, minInterval, motionTimeStamp, motionVector, orientation_id, watch_id, _i, _len, _ref;
