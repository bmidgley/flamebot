...
var Announcer, BigCar, ButtonAnnouncer, CrashAnnouncer, LittleCar, LocationAnnouncer, OrientationAnnouncer, RobotBatteryLimit, RobotFindingState, RobotFlaggingState, RobotLoopState, RobotPhotographingState, RobotSequentialState, RobotState, RobotTestMachine, RobotTimeLimit, StateTracker, TimeAnnouncer, bot,
...
RobotFlaggingState = (function(_super) {
  ...
  function RobotFlaggingState(driver, name, goals, target) {
    ...
    RobotFlaggingState.__super__.constructor.call(this, name, goals, function(currentState, event) {
      if (event.location) {
        this.target.addChild(new RobotFindingState(driver, "flag: " + name, [], event.location.coords));
        return this.parent;
      }
      return null;
    });
...
RobotTestMachine = (function(_super) {
  ...
  function RobotTestMachine(driver) {
    ...
    this.addChild(new RobotFlaggingState(this.driver, "storing", ["store"], this.sequence));
