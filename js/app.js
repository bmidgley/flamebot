...
var RobotBatteryLimit, RobotFindingState, RobotFlaggingState, RobotLoopState, RobotPhotographingState, RobotSequentialState, RobotState, RobotTestMachine, RobotTimeLimit, announceBotEvent, carSocket, drive, drive2, drive2command, finderBotState,
...
drive2 = function(code) {
  ...
  return carSocket.send(drive2command(code));
};
